...
class UserManager_new(BaseUserManager):
...
class User_new(AbstractBaseUser, PermissionsMixin):
    ...
    objects = UserManager_new()

    def __str__(self):
        return self.email

class Employee_new(models.Model):
    user = models.OneToOneField(User_new, related_name="employee", on_delete=models.CASCADE, null=True)
